...
Please see the [Beanstalk Protocol doc][proto] for detailed explanation of
`stats` and `stats-tube` commands output.
...
[proto]: https://raw.githubusercontent.com/kr/beanstalkd/master/doc/protocol.txt
